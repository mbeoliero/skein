...
// hot_update_ratio is pg_stat_user_tables.n_tup_hot_upd / n_tup_upd on job_run.
// It includes all updates and depends on the workload mix.
// The 95% acceptance threshold applies only to isolated heartbeat updates.
